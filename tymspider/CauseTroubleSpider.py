...
from tymspider.tymspider.items import CauseTroubleItem
import scrapy
...
class CauseTroubleSpider(scrapy.Spider):
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item["guardianName"] = row["family"]
            item["guardianContact"]=row["familyTel"]
            item["diagnosisType"]=row["diagnosticTypeStr"]
            item["dangerEstimateLevel"] = row["riskDegreeLabel"]
            item["cure"] = row["treatInfoStr"]
