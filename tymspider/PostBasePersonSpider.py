...
class PostBasePersonSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        print(cookie_items)
        window.close()
        #https://quannan.netalent.cn:8086/quannan_v3/api/person/save
        self.base_url = {
            "baseperson": "https://quannan.netalent.cn:8086/quannanv3/api/person/save"
        }
        self.cookiedict = {}
        ...
        for (region_on, name, person_type, nowland, registered_place, idcard, sex, nation, birthday, contact) in self.data:
            api_data = {}
            api_data['regionNo'] = region_on
            api_data['name'] = name
            ...
            yield Request(url, method="POST",
                              ...
                              cookies=self.cookiedict, callback=self.parse_json,meta=metadata)
    ...
    def parse_json(self, response):
        ...
        if(res_data["code"]=="200"):
           ...
           # print("[info]:::::::::::::insert sucess:::::::::::::::::::::::::::::::: [count]: "+str(self.success)+" cidcard: "+str(idcard))
            ...
            print("[info]:::::::::::::insert fails::::::::::::::::::::::::::::::::  [count]:  "+str(self.fails)+" idcard: "+str(idcard)+" success "+str(self.success))
    ...
    def getdata(self):
        self.open_sqlite3()
        sql_select = "select * from base_person1 "
