...
from tymspider.tymspider.items import PopulationsItem
import scrapy
...
class PopulationsSpider(scrapy.Spider):
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item['youth_type'] = row['mitypeStr']
            item["person_id"] = "0"
            item["crimeSituation"]="0"
            item["familySituation"]="100272"
            item["guardianId"]="0"
            item["guardianRelative"]="100273"
            item["helpContact"] = row['guarContact']
            item["helpMethod"] = "100361"
            item['helpName']= row['guarName']
            item["helpSituation"] = "0"
            item["isCrime"] = "false"
