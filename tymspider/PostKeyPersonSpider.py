...
class PostKeyPersonSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        window.close()
        self.base_url = {
            "keyPerson": "https://quannan.netalent.cn:8086/quannanv3/api/keyPerson/save",
        ...
        for (idcard,interviewReason) in self.data:
            api_data = {}
            api_data['idcard'] = idcard
            item_no = {}
            item_no["idcard"]=str(idcard)
            item_no["interviewReason"]=str(interviewReason)
    ...
    def parseBuildId(self,response):
        ...
        #print(res_data)
        url = self.base_url["keyPerson"]
        mate_item = response.meta
        api_data = {}
        api_data['personId'] = str(res_data["id"])

        api_data["interviewType"]=str("101701")
        api_data["interviewStatus"]=str("101710")
        api_data["processStatus"]=str("101686")
        api_data["interviewReason"]=mate_item["interviewReason"]
    ...
    def getdata(self):
        self.open_sqlite3()
        sql_select = "select idcard ,interviewReason from keyperson "
