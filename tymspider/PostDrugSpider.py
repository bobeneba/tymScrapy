...
class PostDrugSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        window.close()
        self.base_url = {
            "drug": "https://quannan.netalent.cn:8086/quannanv3/api/drug/save",
    ...
    def parseBuildId(self,response):
        ...
        #print(res_data)
        url = self.base_url["drug"]
        mate_item = response.meta
        api_data = {}
        api_data['personId'] = str(res_data["id"])

        api_data["firstDate"]=str("2999-04-06")
        api_data["drugControl"]=str(101380)
        api_data["controlName"]="None"
        api_data["helpName"]="None"
        api_data["controlContact"] = "None"
        api_data["helpContact"] = "None"
    ...
    def getdata(self):
        self.open_sqlite3()
        sql_select = "select idcard ,name from Drug "
