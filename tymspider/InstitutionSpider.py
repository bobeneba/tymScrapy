...
from tymspider.tymspider.items import InstitutionItem
import scrapy
...
class InstitutionSpider(scrapy.Spider):
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item["institutionName"] = row['name']

            item['institutionType'] = row['teamTypeStr']

            item['institutionLevel'] = row['orgLevelStr']
