...
from tymspider.tymspider.items import BasebuildingItem
import scrapy
...
class BasebuildingSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        self.base_url = {
           ...
           # "releaseCriminal":"http://172.10.128.130:10001/zzgrid/zzgl/crowd/releasedRecord/listDataNP.json?"
            "Basebuilding":"http://172.10.128.130:10001/zzgrid/zzgl/grid/areaRoomInfo/room-data.json?"
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item['name'] = row['buildingName']
            item["floor"] = row["floor"]
            item["code"]=row["roomName"]
            item["address"]=row["roomAddress"]
