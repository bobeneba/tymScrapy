...
from tymspider.tymspider.items import CommunityItem
import scrapy
...
class CommunitySpider(scrapy.Spider):
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item["rectificationType"] = row["correctType"]
            item["caseType"]=row["caseType"]
            item["specificAccusation"]=row["mainCharge"]
            item["receiveWay"] = "0"
            item["rectificationStart"] = row["startTimeStr"]
            item["rectificationEnd"] = row["endTimeStr"]
