...
from tymspider.tymspider.items import KeypersonItem
import scrapy
...
class KeypersonSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        self.base_url = {
           ...
           # "causeTrouble":"http://172.10.128.130:10001/zzgrid/zzgl/crowd/mentalIllnessRecord/listDataNP.json?"
            "keyPerson" : "http://172.10.128.130:10001/zzgrid/zzgl/crowd/petitioner/listDataByPartyListStandard.json?"
        }
        ...
        for key,value_url in self.base_url.items():
            ...
            for code in codeList:
                ...
                url = value_url + "infoOrgCode=" + str(code[0]).strip() + "&dataStatus=001&page=1&rows=20"
    ...
    def parse_json(self, response):
        ...
        orgcode = re.findall(r"infoOrgCode=(.+)&d",url_from)
        ...
        if(int(total/1000)==0):
            url = crawl_url + "infoOrgCode=" + str(orgcode[0]).strip() + "&dataStatus=001&"
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item["interviewReason"] = row["mainAppeal"]
            item["officialsName"]=row["officialsName"]
            item["chargeName"]=row["chargeName"]
            item["visitNum"] = row["visitNum"]
