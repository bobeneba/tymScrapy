...
from tymspider.tymspider.items import InstitutionTeamItem
import scrapy
...
class InstitutionTeamSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        self.base_url = {
           ...
           # "Organization" : "http://172.10.128.130:10001/zzgrid/zzgl/society/organization/listData.json?"
            "InstitutionTeam":"http://172.10.128.130:10007/gmis/gmis/teamMembers/listData.json?&bizType=0&"
        }
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item["institutionId"] = row['teamName']
            item['phone'] = row['tel']
            item['administrationLevel'] = row['postName']
            item["name"] = row['name']
            item['idCard'] = row['idCard']
            item['born'] = row['born']
            item['sexStr'] = row['sexStr']
