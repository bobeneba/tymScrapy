...
class PostDefenseTeamSpider(scrapy.Spider):
    name = "PostDefenseTeam"
    ...
    def start_requests(self):
        ...
        self.base_url = {
            "institutionteam": "https://quannan.netalent.cn:8086/quannanv3/api/defenseTeam/save",
            "getInsitutionId": "http://localhost:9001/api/getDefenseOrgId",
    ...
    def parseBuildName(self, response):
        ...
        if "code" in res_data:
            ...
            api_data["defenseOrgId"] = item_no["institutionId"]
            api_data["personId"] = str(personId)

            api_data["phone"] = str(contact)
            api_data["duties"] = item_no["administrationLevel"]
    ...
    def getdata(self):
        self.open_sqlite3()
        sql_select = "select  region_no ,institutionId,administrationLevel,name,born from defenseTeam  where born !='None'"
