...
from tymspider.tymspider.items import DefenseOrgItem
import scrapy
...
class DefenseOrgSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        self.base_url = {
           ...
           # "Organization" : "http://172.10.128.130:10001/zzgrid/zzgl/society/organization/listData.json?"
            "DefenseOrg":"http://172.10.128.130:10007/gmis/gmis/prvetionTeam/listData.json?bizType=1&"
        }
    ...
    def parse_item(self, response):
        ...
        for row in res_rows:
            ...
            item["organizationName"] = row['name']
            item['organizationType'] = row['orgLevelStr']
            item["mainFunc"] = row['mainFunc']
            item['manager'] = row['manager']
            item['teamTypeStr'] = row['teamTypeStr']
